...
sol_coverage = final_solve_mat(:,1,R-4);   % Coverage for the configuration resulting from R
sol_error = final_error_mat(:,1,R-4);   % RMSE for the configuration resulting from R
